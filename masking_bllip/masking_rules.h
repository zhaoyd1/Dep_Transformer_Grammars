...
class Node {
 public:
  ...
  int32_t GetComposedPosition() const;
...
struct Chunk {
  ...
  // Composed position of the input token (Only computed for Arcs. For other position,
  // the same as index.)
  Eigen::VectorXi composed_position;
